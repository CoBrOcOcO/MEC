...
// NEU: Funktion für Stream-Downloads
window.downloadFileFromStream = async (fileName, contentStreamReference) => {
    try {
        console.log(`📥 Stream-Download gestartet: ${fileName}`);
        ...
        console.log(`✅ Stream-Download erfolgreich: ${fileName}`);
    } catch (error) {
        console.error(`❌ Stream-Download-Fehler: ${error.message}`);
        alert(`Stream-Download fehlgeschlagen: ${error.message}`);
    }
};