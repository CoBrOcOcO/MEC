...
namespace MECWeb.Localization
{
    public class CultureStringLocalizer<TComponent> : IStringLocalizer<TComponent>
    {
        private readonly IOptions<LocalizationOptions> _localizationOptions;
        private readonly LanguageNotifier _blazorSchoolLanguageNotifier;
        ...
        public CultureStringLocalizer(IOptions<LocalizationOptions> localizationOptions, LanguageNotifier blazorSchoolLanguageNotifier)
        {
